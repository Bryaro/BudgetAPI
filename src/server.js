...
// Ladda dataStructure (Promise) pass -> req.user._id
...
app.post('/budget/users/signup', (req, res) => {
    ...
    // Hash lösenorder och lägg data till database
        ...
        .then(hashed_pw => {
            ...
            user.save()
                .then(user_details => {
                    ...
                    res.status(201).send(resp); // endast email
                })
                .catch(err => {
                    const resp = {
                        status: "error",
